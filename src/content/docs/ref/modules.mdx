...
darkone.service.monitoring = {
  enable = false;
  isNode = lib.hasAttr "features" host && lib.elem "monitoring-node" host.features;
  retentionTime = "30d";
};
```
...
* **nfsDirsPaths** `listOf str` NFS dirs (/srv/nfs/&lt;xxx&gt;) to include in backup configuration
