...
darkone.host.minimal = {
  enable = false;
  secure = false;
  enableHomepage = builtins.hasAttr "homepage" host.services;
  enableForgejo = builtins.hasAttr "forgejo" host.services;
  enableImmich = builtins.hasAttr "immich" host.services;
  enableNextcloud = builtins.hasAttr "nextcloud" host.services;
  enableNetdata = builtins.hasAttr "netdata" host.services;
  enableMonitoring = builtins.hasAttr "monitoring" host.services;
}
...
darkone.service.httpd = {
  ...
  defaultVirtualHost = host.hostname == (mkDomainName name srv.domainName);
  proxyPort = null;
  extraConfig = ;
  locations = "";
