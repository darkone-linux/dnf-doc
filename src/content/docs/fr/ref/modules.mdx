...
{/* t:p 95b84297b5b2706cb95d0cb18ce9d53fa22e49b9486b40fac834f7a4b06bc492 */}
### &#x2728; darkone.service.adguardhome

AdGuard Home entièrement configuré pour la passerelle / routeur local.

:::note
Cette configuration lit la conf `network` dans le fichier `config.yaml`.
Elle utilise le [module DNF dnsmasq](/ref/modules/#-darkoneservicednsmasq) comme DNS en amont et DHCP.
:::

* **enable** `bool` Activer le service local adguardhome
