...
* Les programmes et configurations [des postes](/fr/doc/user-guide/presentation/linux-workstations/) (éducation, bureautique, jeux…).
* L'accès et la configuration des [services en ligne](/fr/doc/user-guide/presentation/services/).
