...
<CardGrid>
  <LinkCard title="Les services en ligne" href="/fr/doc/user-guide/presentation/services/" description="Coffre-fort, photos, messagerie, médias, IA… le mode d'emploi de chaque service." />
  <LinkCard title="Les postes Linux" href="/fr/doc/user-guide/presentation/linux-workstations/" description="Des ordinateurs prêts à l'emploi, simples et sécurisés." />
  <LinkCard title="Les profils d'utilisateurs" href="/fr/doc/user-guide/presentation/profiles/" description="Un profil adapté à chacun : bureautique, création, études, enfants…" />
  <LinkCard title="Les nœuds du réseau" href="/fr/doc/user-guide/presentation/network-nodes/" description="Comprendre les machines qui composent mon cloud." />
</CardGrid>
