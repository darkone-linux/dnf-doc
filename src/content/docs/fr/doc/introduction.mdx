...
| 👤 | Profils utilisateurs | [Profils](https://github.com/darkone-linux/darkone-nixos-framework/tree/main/dnf/home/profiles) et [modules](https://darkone-linux.github.io/ref/modules/#home-manager-modules) [Home Manager](https://github.com/nix-community/home-manager) (admin, gamer…) |
| 🖥️ | Profils d’hôtes | [Profils d’hôtes](https://darkone-linux.github.io/ref/modules/#-darkonehostdesktop) (serveurs, nœuds réseau, postes de travail…) |
...
| 🤗 | Services intelligents | [Immich](https://immich.app/), [Nextcloud](https://nextcloud.com/), [Forgejo](https://forgejo.org/), [Matrix](https://matrix.com/), [Jellyfin](https://jellyfin.org/), [etc.](https://darkone-linux.github.io/ref/modules/#-darkoneserviceadguardhome) |
...
| 🏠 | Page d’accueil | [Page d’accueil automatisée](#page-daccueil-dynamique) pour chaque zone |
...
| 📦 | Modules complets | [Modules NixOS haut-niveau](https://darkone-linux.github.io/ref/modules) faciles à configurer |
| 📐 | Architecture | [Cohérente, extensible, scalable, personnalisable](https://darkone-linux.github.io/doc/introduction/#structure) |
...
- **usr/** Configuration spécifique de mon réseau
  - config.yaml [Ma config principale](/doc/specifications/#the-configuration-file)
...
- var/ Fichiers générés
  - log/ Fichiers de log
  - generated/ [Fichiers générés](/doc/specifications/#the-generator)
    - hosts.nix
    - users.nix
    - network.nix
...
- **[Modules standards](/ref/modules/#standard-modules)** simples et faciles à utiliser.
...
- **[Outils](/doc/user-manual/#just-commands)** pour maintenir une configuration qualitative.
