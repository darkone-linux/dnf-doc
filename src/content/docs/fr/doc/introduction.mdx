...
| 👤 | Profils utilisateurs | [Profils](https://github.com/darkone-linux/darkone-nixos-framework/tree/main/dnf/home/profiles) et [modules](/fr/ref/modules/#modules-home-manager) [Home Manager](https://github.com/nix-community/home-manager) (admin, gamer…) |
...
- **[Modules mixin](/fr/ref/modules/#modules-mixin)** qui composent et configurent les hôtes.
- **[Modules de service](/fr/ref/modules/#modules-de-service)** pour les services auto-hébergés.
- **[Modules système](/fr/ref/modules/#modules-système)** de configuration système de base.
- **[Modules de sécurité](/fr/ref/modules/#modules-de-sécurité)** pour le durcissement du système.
- **[Applications CLI](/fr/ref/modules/#applications-cli)** outils en ligne de commande.
- **[Applications GUI](/fr/ref/modules/#applications-gui)** applications graphiques.
- **[Modules d'administration](/fr/ref/modules/#modules-dadministration)** pour la gestion du parc.
- **[Modules de gestion d'utilisateurs](/fr/ref/modules/#modules-de-gestion-dutilisateurs)** pour les comptes et accès.
- **[Modules Home Manager](/fr/ref/modules/#modules-home-manager)** pour les profils utilisateur.
