...
Les étapes d'installation initiales sont en cours de simplification. En attendant, la [méthode manuelle](/doc/admin-guide/#manual-installation) est disponible dans la 
