...
Mesures complémentaires transverses — Annexe A (C1–C12).
...
Journalisation et auditd (R71–R73).
...
Configuration statique du noyau — recompilation requise (R15–R27).
...
Configuration dynamique du noyau : paramètres de démarrage et sysctls (R8–R14).
...
Services réseau — cloisonnement et supervision (R78–R80).
...
NSS — Bases utilisateur distantes (R69–R70).
...
Gestion des paquets et mises à jour (R58–R61).
...
Configuration matérielle et démarrage sécurisé (R1–R7).
...
### &#x1F48E; darkone.security.services-hardening

Durcissement des services systemd (R62–R66).
...
Comptes utilisateur et authentification (R30–R36).
...
Durcissement système ANSSI BP-028 v2.0 (GNU/Linux).

Module obligatoire activé par `core.nix`. Applique progressivement les
...
* **enable** `bool` Activer le module de durcissement ANSSI BP-028 v2.0 (activé par défaut par core.nix).
