...
* **enableGeneweb** `bool` Enable pre-configured GeneWeb genealogy service
...
* **enableHarmonia** `bool` Enable a local Harmonia Nix binary cache server
...
darkone.host.minimal = {
  ...
  enableGeneweb = attrsets.hasAttrByPath [ "services" "geneweb" ] host;
  ...
  enableHarmonia = attrsets.hasAttrByPath [ "services" "harmonia" ] host;
};
```
