...
* **aiPackages** `listOf package` AI tools reachable from the unattended run (`--ai-model`). Optional:
...
* **aiContext** `nullOr str` Operator guidance (language, style) included in every AI prompt of a
