...
- **[Extensible](#structure)**, scalable, consistent, customizable architecture.
...
- **[Automatic homepage](https://github.com/darkone-linux/darkone-nixos-framework/blob/main/dnf/modules/nix/standard/service/homepage.nix)** with [Homepage](https://github.com/gethomepage/homepage), based on activated services.
